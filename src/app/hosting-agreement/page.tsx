        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-32">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-foreground/80 leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <p>Technical Journals provides a specialized hosting environment exclusively for University-owned academic journals. Our services include server maintenance, technical support, and indexing assistance based on the Technical Journals platform.</p>
            </section>
            <section className="space-y-4">
