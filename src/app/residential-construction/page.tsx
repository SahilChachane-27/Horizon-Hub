...
function ResidentialHero() {
  ...
  return (
    <section id="residential-hero" className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center text-white">
      {heroImage && (
        <Image
      ...
      <div className="relative z-10 p-4 max-w-4xl mx-auto" data-aos="fade-up">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground">
            <a href="#residential-services">Our Services</a>
          </Button>
