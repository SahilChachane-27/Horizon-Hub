    ...
    <section id="hero" className="relative h-screen flex items-center justify-start text-left text-white">
      ...
      <div className="container mx-auto pl-4 sm:pl-16 lg:pl-24 pr-4 sm:pr-6 lg:pr-8">
        <div className="relative z-10 max-w-3xl" data-aos="fade-right">
            ...
            <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground rounded-none transform -rotate-2 hover:rotate-0 transition-transform duration-300">
                <a href="#projects" className='font-bold'>View Our Projects</a>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-accent text-white bg-transparent hover:bg-accent hover:text-accent-foreground rounded-none transform -rotate-2 hover:rotate-0 transition-transform duration-300">
