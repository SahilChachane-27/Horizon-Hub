          ...
          {services.map((service, index) => (
            <div key={index} data-aos="fade-up" data-aos-delay={index * 100}>
              <Card className="text-center bg-card shadow-lg rounded-[70px] flex flex-col py-10 px-8 h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                  ...
                  <Button asChild className="mt-6 bg-accent hover:bg-accent/90 text-accent-foreground rounded-full self-center px-8 py-3 transition-transform duration-300 ease-in-out hover:scale-105">
