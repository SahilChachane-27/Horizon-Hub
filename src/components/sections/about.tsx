...
export function About() {
  return (
    <section id="about" className="py-6 md:py-10 overflow-hidden bg-white">
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-3 space-y-4" data-aos="fade-left">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs md:text-base text-foreground/80 leading-relaxed font-medium">
                Our objective is to provide a secure, scalable, and professional Technical Journals platform based hosting environment where universities can launch, manage, and publish research under their own unique institutional branding.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <Card className="bg-card border-0 border-l-4 border-accent shadow-md rounded-funky overflow-hidden">
                <CardHeader className="py-2 md:py-3 px-4">
                  <CardTitle className="text-primary text-sm md:text-lg font-headline">Our Vision</CardTitle>
                </CardHeader>
                <CardContent className="pb-3 md:pb-4 px-4">
                  <p className="text-[10px] md:text-sm text-foreground/70 leading-relaxed font-medium">
              ...
              <Card className="bg-card border-0 border-l-4 border-accent shadow-md rounded-funky overflow-hidden">
                <CardHeader className="py-2 md:py-3 px-4">
                  <CardTitle className="text-primary text-sm md:text-lg font-headline">Our Mission</CardTitle>
                </CardHeader>
                <CardContent className="pb-3 md:pb-4 px-4">
                  <p className="text-[10px] md:text-sm text-foreground/70 leading-relaxed font-medium">
